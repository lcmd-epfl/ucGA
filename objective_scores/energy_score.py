...
def energy_score(x, y, S1_cutoff=3.8, scaling_S1=1/3.0, T1_cutoff=1.5):
    ...
    TRIANGLE_SCALING = 1.0 / 0.11871871871871865 # Scaling of the energy score, such that the maximum is approx. 1
    ...
    if is_within_triangle(x, y, T1_cutoff, S1_cutoff):
        ...
        TRI = np.array([[T1_cutoff, 2 * T1_cutoff, 0.0], [T1_cutoff, S1_cutoff, 0.0], [S1_cutoff / 2.0, S1_cutoff, 0.0]])
        P = np.array([x, y, 0])
